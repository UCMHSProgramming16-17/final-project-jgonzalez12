...
#create the csv
csvfile = open('scatterplot2.csv', 'w')
...
df = pd.read_csv('scatterplot2.csv')
p = Scatter(df, x = 'Date', y = 'Temperature', color = 'blue', title = "Friend's Birthday Temperature", legend = 'top_right', xlabel = "Year", ylabel = "Temperature")
